          ...
          <div class="inner-page__products-info">
            ...
            <div class="inner-page__products-price-wrapper">
              <div class="inner-page__products-prices">
                <span class="inner-page__products-price-old" v-if="product.isDiscount">{{ product.price.old }}
                ...
                <span class="inner-page__products-price-current">{{ product.price.current }}
