<template>
  <div class="index-page">
    ...
    <!-- INNER PAGE -->
    <div class="inner-page" :class="{active: currentStreamOpen}" v-body-scroll-lock="currentStream" v-if="currentStream">
      ...
      <div class="inner-page__top">
        ...
        <iframe :src="`/player.html?source=${currentStream.stream.player.url}`" frameborder="0" v-else></iframe>
